...
Scenario: Como primer usuario verifico que los enlaces funcionan correctamente
    ...
    And I enter text "New Member Description"
    And I wait for 2 seconds
    And I click email field member
    And I enter text "$email_1"
    And I wait for 2 seconds
    And I click description name on members
    And I wait for 2 seconds
    And I enter text "New Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member Description"
    And I enter text "New Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member DescriptionNew Member Description"
    And I wait for 2 seconds
    And I wait for 2 seconds
